...
// Новая схема
    ...
    mmoKlumba.Lines.Add('');
    mmoKlumba.Lines.Add('У меня продается более 1000! разных брендовых платьев, новых или в идеальном состоянии, по самым демократичным ценам, и около 1300 других брендовых одежек. Если интересно - напишите, скину ссылочку.');
    ...
    mmoKidSt.Lines.Add('');
    mmoKidSt.Lines.Add('Странички в других соцсетях:');
    mmoKidSt.Lines.Add('https://www.facebook.com/chek.anka/');
    mmoKidSt.Lines.Add('http://ok.ru/group/chek.anka');
    mmoKidSt.Lines.Add('https://www.instagram.com/chek_anka/');
    mmoKidSt.Lines.Add('');
    mmoKidSt.Lines.Add('Подписывайтесь на обновления, новинки выставляю каждую неделю ))');

    mmoVK.Lines.Add('Вы можете посмотреть эту вещь, а также более 1000 разных интересных платьев и 1500 других брендовых вещей по самым демократичным ценам на моем сайте, интернет-магазинчике Chek-Anka.com.ua:');
    mmoVK.Lines.Add('');
